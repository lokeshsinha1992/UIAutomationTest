...
public class TestBase {
	...
	protected final static String chromeDriverPath = "C:\\Users\\lokes\\Downloads\\chromedriver.exe";

	protected final static String firefoxDriver = "webdriver.gecko.driver";
	protected final static String firefoxDriverPath = "C:\\Users\\lokes\\Downloads\\geckodriver.exe";

	protected final static String edgeDriver = "webdriver.edge.driver";
	protected final static String edgeDriverPath = "C:\\Users\\lokes\\Downloads\\msedgedriver.exe";
	...
	protected static void getBrowserInfo(WebDriver driver) {
		...
		String version = cap.getBrowserName().toString();
